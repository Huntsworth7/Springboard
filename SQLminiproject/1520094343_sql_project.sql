...
SELECT Facilities.name AS Facility,
CONCAT( Members.surname, ', ', Members.firstname ) AS Name,
...
ELSE Bookings.slots*Facilities.membercost END) - Facilities.initialoutlay - (Facilities.monthlymaintenance*3) AS total_revenue
FROM Bookings
JOIN Facilities ON Bookings.facid = Facilities.facid
GROUP BY 1
ORDER BY 2 DESC 
